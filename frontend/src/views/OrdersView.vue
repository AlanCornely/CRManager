<template>
  <div class="animate-fade-in">
    ...
    <q-card flat class="rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
      ...
      <!-- Advanced Filters Dropdown (Simulated) -->
      <q-slide-transition>
    ...
    <q-dialog v-model="isOrderDialogOpen">
      <q-card style="min-width: 400px; border-radius: 16px;">
        ...
        <q-card-section class="space-y-4 q-pt-md">
          ...
          <q-input outlined v-model="orderForm.total" label="Valor Total (Ex: $150.00)" />
...
const orderForm = ref({ id: '', customer: '', total: '', status: 'Processando' })
...
const rows = ref([
  { id: '#ORD-001', customer: 'Alice Johnson', date: '2025-03-10', total: '$120.00', status: 'Processando' },
  { id: '#ORD-002', customer: 'Bob Smith', date: '2025-03-09', total: '$85.50', status: 'Entregue' },
  { id: '#ORD-003', customer: 'Charlie Brown', date: '2025-03-08', total: '$210.00', status: 'Enviado' },
  { id: '#ORD-004', customer: 'Diana Prince', date: '2025-03-08', total: '$15.99', status: 'Entregue' },
  { id: '#ORD-005', customer: 'Evan Wright', date: '2025-03-07', total: '$450.00', status: 'Processando' },
  { id: '#ORD-006', customer: 'Fiona Gallagher', date: '2025-03-06', total: '$65.00', status: 'Entregue' },
  { id: '#ORD-007', customer: 'George Miller', date: '2025-03-05', total: '$99.90', status: 'Enviado' },
])
...
const openCreateDialog = () => {
  ...
  orderForm.value = { id: '', customer: '', total: '', status: 'Processando' }
...
const saveOrder = () => {
  if (isEditing.value) {
    ...
    rows.value.unshift({
      ...
      total: orderForm.value.total || '$0.00',
